...
A little note: I do have a screen overlay to reduce the camera area, but often if you're struggling to scan a barcode removing it tends to have better results.
