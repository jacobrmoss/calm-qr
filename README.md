...
|---|---|---|---|
| ![Barcode](screenshots/calm-qr-simple-barcode.png) | ![Barcode Verify](screenshots/calm-qr-barcode-verify.png) | ![Browser Link](screenshots/calm-qr-browser-link.png) | ![Home](screenshots/calm-qr-homescreen-blank.png) |
...
I've made many improvements for verifying the barcode is parsed correctly however it will always need human eyes. Keep in mind that not all barcode shapes are supported so some may never be scanned correctly.
...
### Auto-focus is best effort
I recommend tap to focus if you know where the code is. When left for the device to decide I have a few tricks I've added to try and focus automatically but it simply can't beat the speed and reliability of you just tapping on the screen where the code is and having the camera auto focus and do the rest.
