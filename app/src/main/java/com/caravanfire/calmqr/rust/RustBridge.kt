...
object RustBridge {
    ...
    /** Decode a barcode/QR code from raw luminance bytes. When tryHarder is true, spends more time analyzing. Returns null if nothing found. */
    external fun decodeBarcode(lumaBytes: ByteArray, width: Int, height: Int, tryHarder: Boolean): DecodeResult?
